...
void GameObject::SetupPipeline()
{
    ...
    pipeMan.SetVertexShader(
        mvp, loadShaderModule(renderer->device.device,
                              "shaders/gameObject_shader.vert.spv"));
    pipeMan.SetFragmentShader(
        mvp, loadShaderModule(renderer->device.device,
                              "shaders/gameObject_shader.frag.spv"));
    ...
    pipeMan.SetVertexShader(
        mvp, loadShaderModule(renderer->device.device,
                              "shaders/normalVecDebug.vert.spv"));
    pipeMan.SetFragmentShader(
        mvp, loadShaderModule(renderer->device.device,
                              "shaders/normalVecDebug.frag.spv"));
    pipeMan.SetGeometryShader(
        mvp, loadShaderModule(renderer->device.device,
                              "shaders/normalVecDebug.geom.spv"));
