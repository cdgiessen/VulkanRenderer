...
void Water::SetupPipeline()
{
	...
	pipeMan.SetVertexShader(mvp, loadShaderModule(renderer->device.device, "shaders/water.vert.spv"));
	pipeMan.SetFragmentShader(mvp, loadShaderModule(renderer->device.device, "shaders/water.frag.spv"));
	...
	pipeMan.SetVertexShader(mvp, loadShaderModule(renderer->device.device, "shaders/Seascape.vert.spv"));
	pipeMan.SetFragmentShader(mvp, loadShaderModule(renderer->device.device, "shaders/Seascape.frag.spv"));
