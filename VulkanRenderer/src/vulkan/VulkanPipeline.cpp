...
{
	return std::make_shared<PipelineCreationObject>();
...
VkPipeline VulkanPipeline::BuildPipeline(std::shared_ptr<PipelineCreationObject> pco, VkRenderPass renderPass, VkPipelineCreateFlags flags)
{
...
void VulkanPipeline::SetVertexShader(std::shared_ptr<PipelineCreationObject> pco, VkShaderModule vert)
{
...
void VulkanPipeline::SetFragmentShader(std::shared_ptr<PipelineCreationObject> pco, VkShaderModule frag)
{
...
void VulkanPipeline::SetGeometryShader(std::shared_ptr<PipelineCreationObject> pco, VkShaderModule geom)
{
...
void VulkanPipeline::SetTesselationShader(std::shared_ptr<PipelineCreationObject> pco, VkShaderModule tess)
{
...
void VulkanPipeline::SetInputAssembly(std::shared_ptr<PipelineCreationObject> pco, VkPrimitiveTopology topology, VkPipelineInputAssemblyStateCreateFlags flag, VkBool32 primitiveRestart)
{
	pco->inputAssembly = initializers::pipelineInputAssemblyStateCreateInfo(topology, flag, primitiveRestart);
}

void VulkanPipeline::SetDynamicState(std::shared_ptr<PipelineCreationObject> pco, uint32_t dynamicStateCount, VkDynamicState* pDynamicStates, VkPipelineDynamicStateCreateFlags flags) {
...
void VulkanPipeline::SetViewport(std::shared_ptr<PipelineCreationObject> pco, float width, float height, float minDepth, float maxDepth, float x, float y)
{
...
void VulkanPipeline::SetScissor(std::shared_ptr<PipelineCreationObject> pco, uint32_t width, uint32_t height, uint32_t offsetX, uint32_t offsetY)
{
	pco->scissor = initializers::rect2D(width, height, offsetX, offsetY);
}

//Currently only supports one viewport or scissor
void VulkanPipeline::SetViewportState(std::shared_ptr<PipelineCreationObject> pco, uint32_t viewportCount, uint32_t scissorCount, VkPipelineViewportStateCreateFlags flags)
{ 
...
void VulkanPipeline::SetRasterizer(std::shared_ptr<PipelineCreationObject> pco, VkPolygonMode polygonMode, VkCullModeFlagBits cullModeFlagBits, VkFrontFace frontFace, 
...
void VulkanPipeline::SetMultisampling(std::shared_ptr<PipelineCreationObject> pco, VkSampleCountFlagBits sampleCountFlags)
{
...
void VulkanPipeline::SetDepthStencil(std::shared_ptr<PipelineCreationObject> pco, VkBool32 depthTestEnable, VkBool32 depthWriteEnable, VkCompareOp depthCompareOp, VkBool32 depthBoundsTestEnable, VkBool32 stencilTestEnable)
{
...
void VulkanPipeline::SetColorBlendingAttachment(std::shared_ptr<PipelineCreationObject> pco, VkBool32 blendEnable, VkColorComponentFlags colorWriteMask, 
...
void VulkanPipeline::SetColorBlending(std::shared_ptr<PipelineCreationObject> pco, uint32_t attachmentCount, const VkPipelineColorBlendAttachmentState * attachments)
{
...
void VulkanPipeline::SetDescriptorSetLayout(std::shared_ptr<PipelineCreationObject> pco, VkDescriptorSetLayout* descriptorSetlayouts, uint32_t descritorSetLayoutCount)
{
