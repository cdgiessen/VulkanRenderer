...
//	// true, 3); vulkanCubeMap = renderer.texture_manager.CreateCubeMap (skyboxCubeMap, details);
//}
//
...
//	// writes.push_back (DescriptorUse (1, 1, renderer.texture_manager.GetResource
