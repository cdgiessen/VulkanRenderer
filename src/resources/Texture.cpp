...
void TextureResource::LoadTextureData(std::string path, TexturePixelType type) {
...
void TextureManager::LoadTextureList() {
	if (fileExists("assets/TextureList.json")) {
		try {

		}
		catch (std::runtime_error e) {
			Log::Debug << "Texture List was incorrect, creating new one";
			SaveTextureList();
		}
	}
	else {
...
void TextureManager::SaveTextureList() {
	nlohmann::json j;
