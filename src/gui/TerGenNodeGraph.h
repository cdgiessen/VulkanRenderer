...
//
//		T GetValue(const int x, const int y, const int z, std::map<int, std::shared_ptr<INode>>& map) const;
//
//		T GetData() const;
//		void SetValue(T);
//
...
//
//		virtual bool SetInputLink(int index, int nodeIndex) = 0;
//		virtual bool ResetInputLink(int index) =0;
//
//		virtual void SetValue(const int linkIndex, float value) = 0;
//		virtual void SetValue(const int linkIndex, int value) = 0;
//		virtual void SetValue(const int linkIndex, double value) = 0;
//		virtual void SetValue(const int linkIndex, glm::vec2 value) = 0;
//		virtual void SetValue(const int linkIndex, glm::vec3 value) = 0;
//		virtual void SetValue(const int linkIndex, glm::vec4 value) = 0;
//
//		virtual void SetNodeRefMap(std::map<int, std::shared_ptr<INode>>& map) = 0;
//
//		//because class inheritance is hard. (no really, I wish I had a better non-inheritance solution. But this is better than nothing.
...
//	public:
//
//		Node(LinkType outputLinkType, std::map<int, std::shared_ptr<INode>>& map);
...
//
//		virtual bool SetInputLink(int index, int node) = 0;
//		virtual bool ResetInputLink(int index) = 0;
//
...
//
//		void SetNodeRefMap(std::map<int, std::shared_ptr<INode>>& map) override;
//
//	protected:
//		std::map<int, std::shared_ptr<INode>>& nodeMapRef;
//
//	private:
//		LinkType outputType;
//		T outputValue;
...
//	public:
//		OutputNode(std::map<int, std::shared_ptr<INode>>& map);
//		~OutputNode() override;
//
//		float GetValue(const int x, const int y, const int z, float dummy) const override;
//
//		bool SetInputLink(int index, int node) override;
...
//	public:
//		ConstantFloatNode(float value, std::map<int, std::shared_ptr<INode>>& map);
...
//	public:
//		ConstantIntNode(int value, std::map<int, std::shared_ptr<INode>>& map);
...
//	public:
//		BlendNode(std::map<int, std::shared_ptr<INode>>& map);
//		~BlendNode();
//
//		float GetValue(const int x, const int y, const int z, float dummy) const override;
//
...
//	public:
//		ClampNode(std::map<int, std::shared_ptr<INode>>& map);
//		~ClampNode();
//
//		float GetValue(const int x, const int y, const int z, float dummy) const override;
//
...
//	public:
//		NoiseSourceNode(std::map<int, std::shared_ptr<INode>>& map);
...
//		int GetNextID();
//
//		const std::vector<int>& GetNoiseSources()const ;
//		const std::map<int, std::shared_ptr<INode>>& GetNodeMap() const;
//	private:
//		int IDCounter = 0;
