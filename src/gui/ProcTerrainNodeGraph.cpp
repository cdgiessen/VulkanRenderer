...
namespace SampleNodeGraphWindow {
	...
	*/
	...
	void ProcTerrainNodeGraph::DrawNodeButtons() {
		...
		ImGui::BeginChild("Sub2", ImVec2(90,300), true);
		...
		if (ImGui::Button("Perlin Noise", ImVec2(-1.0f, 0.0f))) {	}
		if (ImGui::Button("Simplex Noise", ImVec2(-1.0f, 0.0f))) {	}
		if (ImGui::Button("Value Noise", ImVec2(-1.0f, 0.0f))) {	}
		if (ImGui::Button("Cellular Noise", ImVec2(-1.0f, 0.0f))) {	}
