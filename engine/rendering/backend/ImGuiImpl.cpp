...
//  2018-08-25: Vulkan: Fixed mishandled VkSurfaceCapabilitiesKHR::maxImageCount=0 case. 2018-06-22:
//  Inverted the parameters to ImGui_ImplVulkan_RenderDrawData() to be consistent with other
//  bindings. 2018-06-08: Misc: Extracted imgui_impl_vulkan.cpp/.h away from the old combined
...
static void ImGui_ImplVulkan_SetupRenderState (
    ImDrawData* draw_data, VkCommandBuffer command_buffer, ImGui_ImplVulkanH_FrameRenderBuffers* rb, int fb_width, int fb_height)
{
	...
	// Our visible imgui space lies from draw_data->DisplayPps (top left) to draw_data->DisplayPos+data_data->DisplaySize (bottom right). DisplayPos is (0,0) for single viewport apps.
	{
		...
		vkCmdPushConstants (
		    command_buffer, g_PipelineLayout, VK_SHADER_STAGE_VERTEX_BIT, sizeof (float) * 2, sizeof (float) * 2, translate);
	}
}
